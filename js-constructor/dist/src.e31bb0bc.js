...
var model = [{
  ...
  type: 'columns',
  value: ['Приложение на чистом JS, без использования библиотек', 'Узнаешь как работают принципы SOLID и ООП в JavaScript за один курс', 'JS - это просто и интересно'],
  options: {
    styles: {
...
function image(block) {
  var _block$options2 = block.options,
      ims = _block$options2.imageStyles,
      _block$options2$alt = _block$options2.alt,
      alt = _block$options2$alt === void 0 ? '' : _block$options2$alt,
      styles = _block$options2.styles;
  return (0, _utils.row)("<img src=\"".concat(block.value, "\" alt='").concat(alt, "' style=\"").concat((0, _utils.css)(ims), "\" />"), (0, _utils.css)(styles));
}
